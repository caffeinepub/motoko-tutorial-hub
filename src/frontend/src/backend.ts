...
export class Backend implements backendInterface {
    ...
    async getFeaturedTutorials(): Promise<Array<TutorialSummary>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFeaturedTutorials();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTutorial(arg0: string): Promise<Tutorial> {
        if (this.processError) {
            try {
    ...
    async getTutorials(arg0: string | null, arg1: string | null, arg2: string | null): Promise<Array<TutorialSummary>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTutorials(to_candid_opt_n6(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n6(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n6(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserProgress(): Promise<Array<UserProgress>> {
        if (this.processError) {
            try {
    ...
    async markComplete(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async markIncomplete(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
